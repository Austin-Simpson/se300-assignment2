...
public class ParametrizedTest {
        ...
        void testWordsInSentence(String transactionId, int value, int fee, String description, String payer,
                        String payee) throws LedgerException {
                ...
                Transaction nextTransaction = new Transaction(transactionId, value, fee, description, actualPayer,
                                actualPayee);
        ...
        void testTransactionWithInvalidAccount(String invalidAccountName) {
                Account invalidAccount = new Account(null, null); 
                Transaction invalidTransaction = new Transaction("13", 50, 5, "invalid test", invalidAccount,
                                invalidAccount);

                assertThrows(LedgerException.class, () -> ledger.processTransaction(invalidTransaction),
                                "Processing a transaction with an invalid account should throw an exception");
        }
